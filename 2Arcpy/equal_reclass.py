# Author:PasserQi
# Time:2017/11/24
# Desc:Raster data equally reclass from min to max
...
# test param
# rasterPath = r'E:\user\Desktop\test\slope' # the path of raster data
# outPath = r'E:\user\Desktop\test\reclass_tmp' # the path of the resulting raster data
